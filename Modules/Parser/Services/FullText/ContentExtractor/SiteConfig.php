...
namespace Modules\Parser\Services\FullText\ContentExtractor;
...
class SiteConfig
{
    ...
    public $date = array();
    public $strip = array(); // used if undeclared
    ...
    public $next_page_link = array(); // used if undeclared
