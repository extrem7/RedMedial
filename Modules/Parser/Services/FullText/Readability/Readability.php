...
class Readability
{
    ...
    public $articleTitle; // optional - URL where HTML was retrieved
    public $articleContent;
    public $dom = null; // preserves more content (experimental) added 2012-09-19
    public $url = null; //
    public $debug = false; // Cache the body HTML in case we need to re-use it later
    public $lightClean = true; // 1 | 2 | 4;   // Start with all flags set.
    /**
    ...
    function __construct($html, $url = null, $parser = 'libxml')
    {
        ...
        /**
         * @deprecated
         * WPeMatico Full Content do not use HTML5 lib now because it's has little performance.
